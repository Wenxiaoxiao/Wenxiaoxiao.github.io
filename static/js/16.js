  ...
  methods: (0, _extends3.default)({
    ...
    resultFun: function resultFun(type) {
      switch (type) {
        ...
        case 1:
          ...
          break;
        case 2:
          this.$router.push({ path: "/index4/0/" + (this.desLevel + 1) });
          break;
      }
    },
    resultNext: function resultNext() {
      ...
      this.$http.getHttp({
        ...
        _lodash2.default.forEach(_this.resultdata, function (v) {
    ...
    dessFilter: function dessFilter() {
      ...
      _lodash2.default.forEach(this.intell.issList, function (v, i) {
        ...
        if (v.result) {
          ...
          _lodash2.default.forEach(v.arrgeMent, function (e, n) {
            self.resultdata[i].questAry[n] = {};
            self.resultdata[i].questAry[n].question = e.question;
            self.resultdata[i].questAry[n].questionCode = e.questionCode;
            _lodash2.default.forEach(e.questionData, function (r, s) {
              // 遍历问题 获取问题答案
              if (r.check) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_issueList_vue__ = __webpack_require__("opGC");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8074e808_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_issueList_vue__ = __webpack_require__("5YBy");
function injectStyle (ssrContext) {
  __webpack_require__("Toej")
}
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8074e808_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_issueList_vue__["a" /* default */],
