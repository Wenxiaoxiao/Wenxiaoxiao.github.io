...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_result_vue__ = __webpack_require__("zAjL");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2a9634b6_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_result_vue__ = __webpack_require__("tlzp");
function injectStyle (ssrContext) {
  __webpack_require__("DKzY")
}
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2a9634b6_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_result_vue__["a" /* default */],
  ...
  methods: (0, _extends3.default)({
    getInfo: function getInfo() {
      this.$http.getHttp({
        ...
        vm.writeInformDatas = JSON.parse(res.data).info;
        console.log(vm.writeInformDatas);
      });
    },
    ...
    resultNext: function resultNext(type) {
      ...
      if (type == 0) {
        ...
        this.writeInformDatas.writeInform.fromvalue.intelligent.deseaseInfo = this.dessFilter();
        ...
        this.$http.getHttp({
          ...
          if (process.orderPage == 1) {
            window.location.href = location.origin + "/jump.html?url=" + encodeURIComponent("./market/writeInform-moreinsure.html?key=" + data.data + "&proCode=" + _this.intell.int_quey.code + "");
          } else if (process.orderPage == 2) {
            window.location.href = location.origin + "/jump.html?url=" + encodeURIComponent("./market/writeInform-3.html?key=" + data.data + "&proCode=" + _this.intell.int_quey.code + "");
          }
        });
      }
    },
    dessFilter: function dessFilter() {
      var self = this;
      var resultdata;
      _lodash2.default.forEach(this.intell.issList, function (v, i) {
        if (!resultdata) {
          resultdata = v.diseaseDesc;
        } else {
          resultdata = resultdata + "," + v.diseaseDesc;
        }
      });
      return resultdata;
    }
