...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__("Qre+");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3cd63630_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__("0Tch");
function injectStyle (ssrContext) {
  __webpack_require__("2V5v")
}
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3cd63630_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  ...
  methods: (0, _extends3.default)({
    ...
    onillList: function onillList(list, i) {
      if (list.subDiseaseList) {
        ...
        this.$router.push({ path: "/BNIndex/" + (this.pageLevel + 1) + "/" + this.desLevel });
      } else {
        ...
        this.$router.push({ path: "/BN/issue/0/" + this.desLevel + "/" + list.diseaseCode });
      }
      return;
    },
    resultList: function resultList(res) {
      ...
      this.$router.push({ path: "/BN/issueList/" + this.desLevel });
      return false;
    },
