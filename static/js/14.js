...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__("Ued4");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_14b3146f_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__("Xk7u");
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_14b3146f_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  ...
  methods: (0, _extends3.default)({
    ...
    onillList: function onillList(list, i) {
      if (list.subDiseaseList) {
        ...
        this.$router.push({ path: "/index/" + (this.pageLevel + 1) + "/" + this.desLevel });
      } else if (list.result) {
        ...
        //问题存在跳问题页
        this.set_msg({ key: "intelligent", lev: "issList", data: this.intell.issList }); //存储问题列表
        this.$router.push({ path: "/issue/0/" + this.desLevel });
      }
    },
