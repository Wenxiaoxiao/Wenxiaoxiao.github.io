  ...
  methods: (0, _extends3.default)({
    ...
    questionApi: function questionApi(list, index) {
      ...
      if (list.result) {
        ...
        this.set_msg({ key: "intelligent", lev: "issList", data: this.intell.issList });
        this.$router.push({ path: "/issue4/" + (this.pageLevel + 1) + "/" + this.desLevel });
      }
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_issue_vue__ = __webpack_require__("EyRH");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7f7c2438_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_issue_vue__ = __webpack_require__("uggV");
function injectStyle (ssrContext) {
  __webpack_require__("qMC8")
}
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7f7c2438_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_issue_vue__["a" /* default */],
