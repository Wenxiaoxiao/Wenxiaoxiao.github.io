...
import waterfall01 from './waterfall/waterfall01.jpg';
const { Header } = Layout;
...
class Main extends Component {
  ...
  _TypeMenu = (type) =>{
    ...
    if(type==='cn'){
      const topMenu = (
        <div style={{fontSize:'17px',letterSpacing:'10px'}}>
      ...
      const topMenu1 = (
        <div style={{fontSize:'12px'}}>
          ...
          <div className="clickItem" onClick={()=>this.TitleClick("EventNews")} key="Main/EventNews" style={{fontWeight:EventNewsShow?'bold':'normal',whiteSpace:'nowrap'}}>NEWS & EVENT</div>
  ...
  showMain = (type) =>{
    ...
    logo.classList.add('animated','fadeOut','logo1')
      ...
      Controllers.Lang_en(this._Lang_en,'')
		}
		if(type === 'cn'){
      this.setState({topMenuType:'cn'})
      Controllers.Lang_cn(this._Lang_cn,'')
		}
  }
  _Lang_en = (json) =>{
...
//监听滚动条事件
  ...
  UpScroll = (name) =>{
    //console.log('向上滑动')
    this.GoPrevPage(name);
  }

  DownScroll = (name) =>{
    //console.log('向下滑动')
    this.GoNextPage(name);
  }
      ...
      <div className="layout_box">
        ...
        <div className="box">
          ...
          <div className="animated fadeIn MainContent" id="MainContent">
            ...
            <div id="contentBox" style={{width:clientWidth,height:'480px',position:'absolute'}}>
            ...
            {/* Projects */}
              ...
              {/* AboutUs */}
            <div className="AboutUs_Wrapper_Box" style={{marginLeft:0-(clientWidth-1100)/2+20+108+68}}>
