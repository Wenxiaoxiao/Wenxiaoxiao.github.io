(function (h, o, g) {
    ...
    g[h] = {
        ...
        settings: {
            ...
            createPlayer: {
                markup: '          <div class="play-pause">             <p class="play"></p>             <p class="pause"></p>             <p class="loading"></p>             <p class="error"></p>           </div>    <div class="scrubber-box">       <div class="scrubber">             <div class="progress"></div>             <div class="loaded"></div>           </div>     </div>      <div class="time">             <em class="played">00:00</em>/<strong class="duration">00:00</strong>           </div>           <div class="error-message"></div>',
            ...
            loadProgress: function (b) {
                ...
                j(a.loaderClass, this.wrapper).style.width = c.clientWidth * b + "px"
            },
            playPause: function () {
